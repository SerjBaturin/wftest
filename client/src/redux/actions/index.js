import { LOGIN, LOGIN_ASYNC, PING, PING_ASYNC, CASES_ASYNC, CASES, SET_COMPANY_ID } from '../types'
...
export const casesActionAsync = (companyId) => ({ type: CASES_ASYNC, payload: companyId })
export const casesAction = (data) => ({ type: CASES, payload: data })
export const setCompanyId = (companyId) => ({ type: SET_COMPANY_ID, payload: companyId })
